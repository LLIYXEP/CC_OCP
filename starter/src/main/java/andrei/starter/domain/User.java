...
public class User implements UserDetails {
	...
	@OneToMany(mappedBy = "author", cascade = CascadeType.ALL, fetch = FetchType.LAZY) // Ne podgrujati srayu vse soob6eniia usera
    ...
    private Set<User> subscribtions = new HashSet<User>();
